...
class Constants {
    companion object {
        ...
        const val RETROFIT_CLIENT_FOR_SPACE_FLIGHT_API = "retrofit_client_for_space_news_api"
        const val RETROFIT_CLIENT_FOR_LAUNCH_LIBRARY_API = "retrofit_client_for_launch_library_api"
    }
}
